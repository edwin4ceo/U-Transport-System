...
.forgot-card{background:#fff;border-radius:16px;box-shadow:0 10px 30px rgba(0,0,0,0.08);max-width:420px;width:100%;padding:26px 24px 20px;}
.forgot-header{text-align:center;margin-bottom:14px;}
.forgot-icon{width:52px;height:52px;border-radius:50%;border:2px solid #f39c12;display:flex;align-items:center;justify-content:center;margin:0 auto 8px;color:#f39c12;font-size:22px;}
...
.form-group input{width:100%;padding:8px 10px;border-radius:8px;border:1px solid #ccc;font-size:13px;box-sizing:border-box;}
.btn-reset{width:100%;border:none;padding:10px;border-radius:999px;background:linear-gradient(135deg,#f39c12,#e67e22);color:#fff;font-weight:600;cursor:pointer;}
</style>
...
<div class="forgot-wrapper">
  <div class="forgot-card">
    ...
    <form method="post" action="">
      ...
      <button type="submit" name="reset_password" class="btn-reset">Send OTP</button>
    </form>
  </div>
</div>
